...
guard 'shell' do
  watch(/^.*\.adoc$/) {|m|
    ...
    Asciidoctor.render_file("README.adoc", :to_dir => "build", :safe => Asciidoctor::SafeMode::UNSAFE, :attributes=> {'sectnums'=>'','stylesheet'=>'main.css','stylesdir'=>'stylesheets/','icons' =>'font','idprefix' => '', 'idseparator' => '-', 'copycss' => '', 'source-highlighter' => 'rouge', 'sectanchors' => '', 'doctype' => 'book', 'eruby'=>'erubis','toc' => 'left', 'toclevels' => '1', 'revnumber' => '1.0', 'require'=>'asciidoctor-diagram'})
  }
end
