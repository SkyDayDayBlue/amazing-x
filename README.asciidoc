...
* link:#hipster[Hipster]
* link:#version-control[Version Control]
* link:#articles[Articles]
* link:#micro-services[Micro Services]
* link:#mobile-apps-development[Mobile Apps Development]
* link:#communication[Communication]
* link:#companies[Companies]
* link:#docker-images[Docker Images]
* link:#unusual-libs[Unusual Libs]
* link:#ios[iOS]
